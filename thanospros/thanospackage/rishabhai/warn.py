...
@tgbot.on(events.NewMessage(pattern="^/warn"))
async def _(event):
    if event.fwd_from:
        return
...
@tgbot.on(events.NewMessage(pattern="^/warn2"))
async def _(event):
    if event.fwd_from:
        return
...
@tgbot.on(events.NewMessage(pattern="^/warn3"))
async def _(event):
    if event.fwd_from:
        return
...
@tgbot.on(events.NewMessage(pattern="^/warn0"))
async def _(event):
    if event.fwd_from:
        return
...
@tgbot.on(events.NewMessage(pattern="^/ocb"))
async def _(event):
    if event.fwd_from:
        return
...
@tgbot.on(events.NewMessage(pattern="^/fw"))
async def _(event):
    if event.fwd_from:
        return
