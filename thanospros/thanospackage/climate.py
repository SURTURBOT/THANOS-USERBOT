...
from thanospros.utils import admin_cmd, edit_or_reply, errors_handler, sudo_cmd
...
async def set_default_city(city):
    if city.fwd_from:
        return
    """ For .ctime command, change the default thanospros country for date and time commands. """
    if not OWM_API:
        await edit_or_reply(
